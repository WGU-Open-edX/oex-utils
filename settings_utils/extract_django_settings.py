...
def generate_output_file(settings_vars: Set[str], input_file: str, output_file_path: str):
    """
    ...
    try:
        with open(output_file_path, 'w', encoding='utf-8') as f:
            f.write(f'# This file contains all uppercase variable names found in {input_file}\n\n')
        ...
        print(f"Successfully generated '{output_file_path}' with {len(settings_vars)} settings variables.")
...
def main():
    ...
    parser.add_argument(
        'settings_file',
        help='Path to the Django settings file to parse'
    )
    parser.add_argument(
        '--dry-run',
        action='store_true',
