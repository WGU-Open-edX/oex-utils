...
Given two dirs with output generated by `diff_settings.py`, put differing values between each file into an emacs org-mode
table format.

```sh
python table_diff.py main_settings_dump feature_settings_dump > diff.org
```

Output will look something like this:

```
* lms.envs.test_static_optimized__lms_envs_minimal.json
diff main_settings_dump/lms.envs.test_static_optimized__lms_envs_minimal.json feature_settings_dump/lms.envs.test_static_optimized__lms_envs_minimal.json
| SETTING       | main_settings_dump | feature_settings_dump | action |
|---------------+--------------------+-----------------------+--------|
| VIDEO_CDN_URL | {}                 | {'example'}           | TODO   |
```

### `diff_single_setting.py`

Given two dirs with output generated by `diff_settings.py`, provide the diffs of a single setting.

```sh
python diff_single_setting.py TEMPLATES
```
